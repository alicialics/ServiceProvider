...
int main(){
    ...
    Data* database = &sqliteData; //creates a pointer to the reference of sqliteData object
    
    Manager manager(database); //create a manager object with all the sqlitedata information in it
